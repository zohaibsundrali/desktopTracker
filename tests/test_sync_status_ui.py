...
def dashboard_class(clock):
    ...
    namespace = {'input_sync_text': input_sync_text, 'activity_sync_text': activity_sync_text, 'idle_reminder_text': idle_reminder_text, 'break_status_text': break_status_text, 'screenshot_policy_text': screenshot_policy_text, 'time': clock, 'session_sync_text': session_sync_text, 'screenshot_sync_text': screenshot_sync_text,
