...
def dashboard_class(clock):
    ...
    cls.body = [n for n in cls.body if isinstance(n, ast.FunctionDef) and n.name in
                ('_refresh_session_sync_status', '_refresh_screenshot_sync_status', '_refresh_break_status', '_refresh_idle_reminder', '_refresh_activity_sync', '_schedule_timer_update')]
    namespace = {'activity_sync_text': activity_sync_text, 'idle_reminder_text': idle_reminder_text, 'break_status_text': break_status_text, 'screenshot_policy_text': screenshot_policy_text, 'time': clock, 'session_sync_text': session_sync_text, 'screenshot_sync_text': screenshot_sync_text,
